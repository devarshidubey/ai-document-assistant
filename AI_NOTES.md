...
Built entirely in conversation with **Claude (Sonnet 4.6)** in the normal chat interface, no `CLAUDE.md`/`.cursorrules`. I drove all decisions and testing; Claude implemented most pieces and flagged tradeoffs. No AI context file was used.
